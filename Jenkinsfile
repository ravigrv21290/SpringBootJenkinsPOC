pipeline {
	...
	post {
        	always {
				...
				influxDbPublisher target:'jenkins', measurementName: 'Pipeline', customPrefix: '', customProjectName: 'Jenkins Pipeline Statistics', jenkinsEnvParameterField: '', jenkinsEnvParameterTag: ''
			}
